...
<td><div class="txtbox floatL" style="width:300px;"><input id="name" name="name" type="text" size="30" value=""></div></td>
</tr>
<tr>
...
<td><div class="txtbox floatL" style="width:300px;"><input id="keyword" name="keyword" type="text" size="30" value=""></div></td>
</tr> -->
<tr>
<th width="100">价格 <span class="f_cB">*</span> </th>
<td><div class="txtbox floatL" style="width:300px;"><input id="price" name="price" type="text" size="30" value=""></div></td>
</tr>
<tr>
...
<td><div class="txtbox"><textarea  id="minidetail" name="minidetail"  cols="32" rows="3"></textarea></div></td>
</tr>
<tr>
<th width="100">下方详情 <span class="f_cB">*</span> </th>
<td><div class="txtbox"><textarea  id="detail" name="detail"  cols="32" rows="8"></textarea></div></td>
</tr>
</table>
</div>
</div>
