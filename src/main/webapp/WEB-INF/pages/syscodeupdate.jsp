...
<div id="contentwrapper" class="contentwrapper">
        	<div id="basicform" class="subcontent">
					...
					<form class="stdform stdform2" method="post" action="">
                    	...
                    	<p>
                        	<label>编号</label>
                            <span class="field"><input type="text" value="${o.code }"  name="code" id="code" class="longinput" /></span>
                        </p>
                    	<p>
                        	<label>类型</label>
                            <span class="field"><input type="text" value="${o.type }"  name="type" id="type" class="longinput" /></span>
                        </p>
                    	<p>
                        	<label>备注</label>
                    	...
                    	<p>
                        	<label>描述</label>
                            <span class="field"><input type="text" value="${o.desc }"  name="desc_" id="desc_" class="longinput" /></span>
                        </p>
                        <p>
                        	<label>排序</label>
