...
function toAdd(){
 ...
 function toUpdate(id){
	window.location.href = ctx+"/tblbookingsongs/toUpdate2.html?id="+id;
	return false;
}
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/tblbookingsongs/list2.html" id="sForm">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <c:forEach items="${list}" var="o">
                        <tr class="gradeX">
                        	...
                        	<td>${o.colresult }</td>
                            <td>
                            <button  onclick="return toUpdate('${o.id}')">处理</button>
