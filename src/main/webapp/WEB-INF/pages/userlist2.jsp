...
function toAdd(){
 ...
 function toUpdate(id){
	window.location.href = ctx+"/user/toUpdate2.html?id="+id+"&selectType="+$("#selectType").val();
	return false;
}
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/user/list2.html" id="sForm">
                        ...
                        <tr>
                         ...
                         <!--    <th class="head1" width="100px;">密码</th> -->
                          ...
                          <!--   <th class="head1" width="100px;">部门</th>
                            ...
                            <th class="head1" width="100px;">状态</th> -->
