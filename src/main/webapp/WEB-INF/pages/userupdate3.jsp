        	...
        	<div id="basicform" class="subcontent">
					...
					<form class="stdform stdform2" method="post" action="">
                        ...
                        <span class="field" id="infospan">
	                            ...
	                            <span>
	                              &nbsp;&nbsp;&nbsp;&nbsp;
	                             <button class="submit radius2" onclick="return addinfo(this,1)" >新增</button>
	                             <br><br>
	                             </span>
                            ...
                            <c:forEach items="${detaillist}" var="o2">
                            	<span>
	                             &nbsp;&nbsp;&nbsp;&nbsp;月份
	                            <%-- <input   class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"   type="text" value="<fmt:formatDate value="${o2.electricitydate}" pattern="yyyy-MM-dd"/>"    name="electricitydate" id="electricitydate" style="width:10%" class="longinput" /> --%>
	                             <input   class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM',readOnly:true})"   type="text" value="${o2.salarymonth}"    name="salarymonth" id="salarymonth" style="width:10%" class="longinput" /> 
	                            &nbsp;&nbsp;&nbsp;&nbsp;基本工资
	                            <input type="text" value="${o2.salary1 }"   name="salary1" id="salary1" style="width:10%" class="longinput" />
	                            &nbsp;&nbsp;&nbsp;&nbsp;绩效
	                            <input type="text" value="${o2.salary2 }"   name="salary2" id="salary2" style="width:10%" class="longinput" />
	                            &nbsp;&nbsp;&nbsp;&nbsp;全勤奖
	                            <input type="text" value="${o2.salary3 }"   name="salary3" id="salary3" style="width:10%" class="longinput" />
	                              &nbsp;&nbsp;&nbsp;&nbsp;
	                             <button class="submit radius2" onclick="return addinfo(this,2)" >新增</button>
	                              &nbsp;&nbsp;&nbsp;&nbsp;
	                             <button class="submit radius2" onclick="return delinfo(this)" >删除</button>
