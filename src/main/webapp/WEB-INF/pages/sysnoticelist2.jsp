...
<script type="text/javascript">
function toAdd(){
	window.location.href = ctx+"/sysnotice/toAdd.html";
	return false;
}

 function toUpdate(id){
	window.location.href = ctx+"/sysnotice/toUpdate2.html?id="+id;
	return false;
}

function toDetail(id){
	window.location.href = "../sysnotice/toDetail.html?id="+id;
}

function toDelete(id){
	$.ajax({
		url:"../sysnotice/toDelete.html",
		type:"post",
		data:{id:id},
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/sysnotice/list2.html" id="sForm">
    <div class="centercontent tables">
       ...
       <div id="contentwrapper" class="contentwrapper">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <thead>
                        <tr>
                          <th class="head0" width="100px;">标题</th>
                    ...
                    <c:forEach items="${list}" var="o">
                        ...
                        <td>${o.title }</td>
                        	<td>${o.content }</td>
                        	 ...
                        	 <td> <button  onclick="return toUpdate('${o.id}')">查看</button></td>
                        </tr>
 					</c:forEach>
                    </tbody>
                </table>
