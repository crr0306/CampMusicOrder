...
function toAdd(){
 ...
 function toUpdate(id){
	window.location.href = ctx+"/leavemsg/toUpdate.html?id="+id;
	return false;
}
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/leavemsg/list.html" id="sForm">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <c:forEach items="${list}" var="o">
                        <tr class="gradeX">
                            ...
                            <td>
                            <button  onclick="return toUpdate('${o.id}')">回复</button>
