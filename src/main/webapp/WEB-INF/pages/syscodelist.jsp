...
<script type="text/javascript">
function toAdd(){
	window.location.href = ctx+"/syscode/toAdd.html";
	return false;
}

 function toUpdate(id){
	window.location.href = ctx+"/syscode/toUpdate.html?id="+id;
	return false;
}

function toDetail(id){
	window.location.href = "../syscode/toDetail.html?id="+id;
}

function toDelete(id){
	$.ajax({
		url:"../syscode/toDelete.html",
		type:"post",
		data:{id:id},
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/syscode/list.html" id="sForm">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <thead>
                        <tr>
						    ...
						    <th class="head0" width="100px;">编号</th>
						    <th class="head0" width="100px;">类型</th>
						    <th class="head0" width="100px;">备注</th>
						    <th class="head0" width="100px;">描述</th>
