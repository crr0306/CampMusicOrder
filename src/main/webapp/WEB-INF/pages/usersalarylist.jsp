...
<script type="text/javascript">
function toAdd(){
	window.location.href = ctx+"/usersalary/toAdd.html";
	return false;
}

 function toUpdate(id){
	window.location.href = ctx+"/usersalary/toUpdate.html?id="+id;
	return false;
}

function toDetail(id){
	window.location.href = "../usersalary/toDetail.html?id="+id;
}

function toDelete(id){
	$.ajax({
		url:"../usersalary/toDelete.html",
		type:"post",
		data:{id:id},
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/usersalary/list.html" id="sForm">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <thead>
                        <tr>
						    ...
						    <th class="head0" width="100px;">工资</th>
