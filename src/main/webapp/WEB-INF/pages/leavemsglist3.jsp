...
<script type="text/javascript">
function toAdd(){
	window.location.href = ctx+"/leavemsg/toAdd3.html";
	return false;
}

 function toUpdate(id){
	window.location.href = ctx+"/leavemsg/toUpdate3.html?id="+id;
	return false;
}
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/leavemsg/list3.html" id="sForm">
