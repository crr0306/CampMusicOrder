...
<script type="text/javascript">
function toAdd(){
	window.location.href = ctx+"/tblsong/toAdd.html";
	return false;
}
       ...
       <div id="contentwrapper" class="contentwrapper">
                ...
                <div class="tableoptions">
                    <!-- <select class="radius3">
                  	  ...
                  	  歌曲名称&nbsp;
                    <input type="text" name="colname" value="${colname}" style="width:100px;"/>&nbsp;
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <thead>
                        <tr>
						    ...
						    <th class="head0" width="100px;">制作公司</th>
						    <th class="head0" width="100px;">歌词</th>
