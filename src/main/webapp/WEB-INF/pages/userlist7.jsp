...
<script type="text/javascript">
function toAdd(){
	window.location.href = ctx+"/user/toAdd7.html?selectType="+$("#selectType").val();
	return false;
}

 function toUpdate(id){
	window.location.href = ctx+"/user/toUpdate7.html?id="+id+"&selectType="+$("#selectType").val();
	return false;
}
...
<div class="bodywrapper">
    ...
    <form method="post" action="${pageContext.request.contextPath}/user/list7.html" id="sForm">
