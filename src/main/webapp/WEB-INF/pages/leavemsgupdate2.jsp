...
<script type="text/javascript">
function back(){
	window.location.href = ctx+"/leavemsg/list2.html";
	return false;
}
        	...
        	<div id="basicform" class="subcontent">
					...
					<form class="stdform stdform2" method="post" action="">
                        ...
                        <p>
                        	...
                        	<label>回复</label>
                            <span class="field">
                            <textarea readonly="readonly"  name="recontent" id="recontent" cols="10" rows="5" >${o.recontent }</textarea>
                            </span>
                            </p>
                            
                        <p>
                        	<label>回复时间</label>
                            <span class="field"><input readonly="readonly"  type="text" value="<fmt:formatDate value="${o.recreatedate}" pattern="yyyy-MM-dd"/>"  name="recreatedate" id="recreatedate" class="longinput" /></span>
                        </p>
