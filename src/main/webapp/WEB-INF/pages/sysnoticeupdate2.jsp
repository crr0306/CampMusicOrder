...
<script type="text/javascript">
function back(){
	window.location.href = ctx+"/sysnotice/list2.html";
	return false;
}
...
<div id="contentwrapper" class="contentwrapper">
        	<div id="basicform" class="subcontent">
					...
					<form class="stdform stdform2" method="post" action="">
	                    	...
	                    	<p>
	                        	<label>标题</label>
	                            <span class="field"><input readonly="readonly" type="text" value="${o.title }" name="title" id="title" class="longinput" /></span>
	                        </p>
