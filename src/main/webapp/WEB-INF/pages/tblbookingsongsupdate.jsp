...
<div id="contentwrapper" class="contentwrapper">
        	<div id="basicform" class="subcontent">
                    ...
                    <%-- 	<p>
                    	...
                    	<p>
                        	<label>预约时间</label>
                            <span class="field"><input type="text" value="${o.colapptime }"  name="colapptime" id="colapptime" class="longinput" /></span>
                        </p>
                    	<%-- <p>
                        	<label>点歌状态</label>
                            <span class="field"><input type="text" value="${o.coltype }"  name="coltype" id="coltype" class="longinput" /></span>
                        </p>
                    	<p>
                        	<label>处理反馈结果</label>
