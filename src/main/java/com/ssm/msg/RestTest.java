...
public class RestTest {
	...
	public static void main(String[] args) throws IOException{
		...
		if (methodNumber.equals("1")) {  //指定模板单发
			String sid = "12dd2ef8feac7929032e7f58e0e04c29";
			String token = "e3ffa0953780a33b831f62d1f360f431";
			String appid = "81738718c3134964aa3dd08e3966076b";
			String templateid = "468679";
			String param = "1234";
			String mobile = "17621163416";
			String uid = "";
